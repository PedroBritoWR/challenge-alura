...
function removeRightSideBar() {
  const removeRightSideBar = document.querySelector(".container__direito").remove();
  const showRightSideBarOutput = document.querySelector(".container__direito_output").style.display = 'flex';
}
